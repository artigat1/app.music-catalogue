...
export class MusicEditFormComponent implements OnInit {
    ...
    @Output() submit = new EventEmitter<Music>();
    ...
    private initForm(): void {
        ...
        if (this.music) {
            ...
            composer = this.music.composer
                ? this.music.composer.join(', ')
                : '';
            lyricist = this.music.lyricist
                ? this.music.lyricist.join(', ')
                : '';
